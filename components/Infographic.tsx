...
import { Download, Sparkles, Edit3, Maximize2, X, ZoomIn, ZoomOut, Volume2 } from 'lucide-react';
...
const Infographic: React.FC<InfographicProps> = ({ image, onEdit, isEditing, onSpeak }) => {
